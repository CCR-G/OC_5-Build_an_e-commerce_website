...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"BasketUserInterface\": () => (/* binding */ BasketUserInterface)\n/* harmony export */ });\n/* harmony import */ var _utils_get_data_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils/get-data-element */ \"./src/user-interfaces/utils/get-data-element.js\");\n/* harmony import */ var _utils_create_basket_item_card__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/create-basket-item-card */ \"./src/user-interfaces/utils/create-basket-item-card.js\");\n/* harmony import */ var _basket_item_user_interface__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./basket-item-user-interface */ \"./src/user-interfaces/basket-item-user-interface.js\");\n\r\n\r\n\r\n\r\nconst BasketUserInterface = {\r\n    set content(basket_content) {\r\n        for (const basket_item_id in basket_content) {\r\n            const basket_item = basket_content[basket_item_id];\r\n\r\n            _basket_item_user_interface__WEBPACK_IMPORTED_MODULE_2__.BasketItemUserInterface.basketItemDetails = basket_item;\r\n\r\n            _basket_item_user_interface__WEBPACK_IMPORTED_MODULE_2__.BasketItemUserInterface.proposeToEditBasketItemQuantity(basket_item);\r\n\r\n            _basket_item_user_interface__WEBPACK_IMPORTED_MODULE_2__.BasketItemUserInterface.proposeToRemoveBasketItem(basket_item);\r\n        }\r\n    },\r\n\r\n    set totalPrice(basket_total_price) {\r\n        const price_container = (0,_utils_get_data_element__WEBPACK_IMPORTED_MODULE_0__.getDataElement)(\"basket-price\");\r\n        price_container.textContent = basket_total_price;\r\n    },\r\n\r\n    proposeToClearBasket() {\r\n        const clear_basket_button = (0,_utils_get_data_element__WEBPACK_IMPORTED_MODULE_0__.getDataElement)(\"basket-clear\");\r\n        clear_basket_button.addEventListener(\"click\", handleClearBasketEvent);\r\n    },\r\n\r\n    proposeToCommandBasketContent() {\r\n        const command_form = (0,_utils_get_data_element__WEBPACK_IMPORTED_MODULE_0__.getDataElement)(\"command-form\");\r\n        command_form.addEventListener(\"submit\", handleCommandEvent);\r\n    },\r\n\r\n    disableCommandRequest() {\r\n        const command_form = (0,_utils_get_data_element__WEBPACK_IMPORTED_MODULE_0__.getDataElement)(\"command-form\");\r\n        command_form.submit.disabled = true;\r\n    },\r\n}\r\n\r\nfunction handleClearBasketEvent() {\r\n    document.dispatchEvent(\r\n        new CustomEvent('clear_basket_button_clicked'),\r\n    );\r\n}\r\n\r\nfunction handleCommandEvent(event) {\r\n    event.preventDefault();\r\n\r\n    document.dispatchEvent(\r\n        new CustomEvent('command_form_sent', {\r\n            detail: {\r\n                full_name: event.target.full_name.value,\r\n                used_name: event.target.used_name.value,\r\n                address: event.target.address.value,\r\n                town: event.target.town.value,\r\n                email: event.target.email.value,\r\n            }\r\n        }),\r\n    )\r\n\r\n    event.target.reset();\r\n}\r\n\n\n//# sourceURL=webpack://orinoco/./src/user-interfaces/basket-user-interface.js?");
